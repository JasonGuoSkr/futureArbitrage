...
def strategy(underlying_list, start_date, end_date, diff=0.0015, stop=-0.001, close=0.001, close_len=7200):
    # 数据加载
    ...
    for date in date_list:
        ...
        initial_spread = daily_spread.iloc[0, 4]
        ...
        for order in range(1, daily_spread.shape[0] - 1):
            ...
            if not hold_par:
                if last_spread - initial_spread >= diff:
                ...
                elif last_spread - initial_spread <= -diff:
                    open_spread = last_spread
                    open_order = order
                    pos_par = -1
                    hold_par = True
...
if __name__ == '__main__':
    ...
    tradeDetails = strategy(underlyingList, startDate, endDate, diff=diffPar, stop=stopPar, close=closePar, close_len=closeLen)
